System.register(['angular2/core', 'angular2/platform/browser', 'angular2/router', 'components/LoginComponent', 'components/HomeComponent', 'components/AboutComponent', 'components/ContactComponent', 'components/ProtectedComponent', 'services/AuthService'], function(exports_1, context_1) {
    "use strict";
