System.register(['angular2/core', 'angular2/router', 'components/products/MainComponent', 'components/products/InterestComponent', 'components/products/SportifyComponent', 'components/products/ByIdComponent'], function(exports_1) {
